...
clean:
	rm -r $(shell pwd -P)/build/solgraphs/$(contract).png
	rm -r $(shell pwd -P)/build/markdocs/$(contract).md
	rm -r $(shell pwd -P)/build/*.png
	rm -r $(shell pwd -P)/build/merged/$(contract)/*
	rm -r $(shell pwd -P)/build/compiled/$(contract)/*
...
graphdepends:
	$(shell pwd -P)/node_modules/solidity-graph/index.js $(shell pwd -P)/contracts/$(dir) --output $(shell pwd -P)/build/temp/ -c
